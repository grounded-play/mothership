...
export default function MiniPlayer() {
    ...
    return (
        <div className="relative w-[236px] max-w-full rounded-2xl border border-white/10 bg-black/88 p-2.5 shadow-[0_12px_40px_rgba(0,0,0,0.55)] backdrop-blur-xl">
            ...
            <div className="mb-2 flex items-center justify-between text-[9px] font-mono text-gray-400">
            ...
            <div className="flex items-center gap-1.5">
                <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition-colors hover:border-white/25 hover:bg-white/10"
                ...
                <button
                    ...
                    className="flex h-9 flex-1 items-center justify-center gap-1.5 rounded-full border border-neon-cyan/40 bg-cyan-500/10 px-3 text-neon-cyan transition-colors hover:border-neon-cyan hover:bg-cyan-500/15"
                >
                    {!snapshot.unlocked || !snapshot.isPlaying ? <Play className="h-3.5 w-3.5" /> : <Pause className="h-3.5 w-3.5" />}
                    <span className="text-[10px] font-bold uppercase tracking-[0.18em]">{playLabel}</span>
                </button>
                <button
                    type="button"
            ...
            <div className="mt-2 flex items-center justify-between text-[8px] uppercase tracking-[0.14em] text-gray-500">
